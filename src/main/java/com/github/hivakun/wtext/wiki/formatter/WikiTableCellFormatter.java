 ...
 * @see Table
 */
public class WikiTableCellFormatter implements TableCellFormatter {


    @Override
    public String colspan(@NotNull String val) {
        return WikiTableMarkup.COLSPAN.apply(val);
    }

    @Override
    public String rowspan(@NotNull String val) {
        return WikiTableMarkup.ROWSPAN.apply(val);
    }
